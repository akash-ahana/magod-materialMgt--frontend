...
function PurchasePartsOpenRVList() {
  ...
  const openButtonClick = () => {
    ...
    nav("/materialmanagement/receipt/openbuttonreceivedclosedpartlist", {
      state: { id: data.RvID },
    });
    //<OpenClosedRVList />;
  };
  ...
  return (
    <div>
      <>
        <h4 className="form-title">Magod : Parts Receipt List Received</h4>
...
export default PurchasePartsOpenRVList;
